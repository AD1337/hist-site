...
**We want to create the first grand strategy game with Overwhelmingly Positive reviews on Steam**. Well, depending on what you consider a GSG, this has already been done. Regardless, that is our goal. We don't know if we'll make it with our first game, but if not, we'll hopefully try again. The requirements are: at least 500 reviews, and a 95%+ positive rating.
